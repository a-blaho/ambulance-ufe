...
describe('abl-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<abl-ambulance-wl-editor entry-id="test-entry"
           ambulance-id="test-ambulance" api-base="http://sample.test/api">
        </abl-ambulance-wl-editor>`,
    });
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
      components: [AblAmbulanceWlEditor],
      html: `<abl-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></abl-ambulance-wl-editor>`,
    });
